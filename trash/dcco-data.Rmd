...
devtools::install_github("trashbirdecology/dubcorms", force=FALSE, dependencies = FALSE)## change to dependencies=TRUE when not in dev mode
...
## if this function throws a non-intuitive error, try again. 
message("..done.")

# view expected data strucutre of jdat lists
View(jdat$metadata)
```
