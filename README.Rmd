...
Also recommend creating a very small version of the same data for testing models:
```{r devdata}
...
Define the directory for the desiored project (species, region, years, grid size):
```{r model-dirs} 
