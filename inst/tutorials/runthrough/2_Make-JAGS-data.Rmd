...
area.bbs <- scale(grid.bbs$area)  # just a list of the areas
prop.site.in.cell.bbs <- make_mat(grid.bbs, val="proprouteincell", replace.na=TRUE)# this should have no missing data
```
...
names.bbs <- c(
 ...
 "area.bbs", # scaled area of a grid cell (Vec)
 # indexing
