...
## export model
# browseURL(mod.fn)
mod.name <- paste0(dir.models,"/bbs-pois-base") ## not sure why but when i knit the chunks outside this one it doesn't keep the params, so having trouble putting it up there.
