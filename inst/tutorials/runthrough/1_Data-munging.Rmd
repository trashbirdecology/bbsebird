...
```{r specs-dirs}
  if(!endsWith(params$dir.proj,"/")) params$dir.proj <- paste0(params$dir.proj,"/")
...
sapply(c(dir.proj.out, dir.bbs.out, dir.ebird.out, dir.models, dir.spatial.out, dir.jags, dir.plots), FUN=function(x) dir.create(x, showWarnings = FALSE))
```
...
# Step 4: Align eBird and BBS Data Further
