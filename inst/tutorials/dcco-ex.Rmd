...
devtools::install_github("trashbirdecology/dubcorms", force=FALSE,ref="dev-jlb")
...
saveRDS(gam, file=paste0(dir.models, mod.name, ".rds"))
gam$jags.ini %>% str() # b, rho, X
gam$jags.data %>% str() # y, n, X
```
