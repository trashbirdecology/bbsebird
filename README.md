...
<!-- sink(mod.fn) --> <!-- cat(model.base, sep = "") --> <!-- sink() -->
...
<!-- <!--   myModel = mod.fn, --> –> <!-- <!--   myData = bugs.dat, -->
–> <!-- <!--   myInits = set.inits(n=1, dat=bugs.dat), --> –>
<!-- <!--   # myInits = inits, --> –> <!-- <!--   parallel = TRUE, -->
–> <!-- <!--   mcmc.specs = myMCMC.specs,   --> –>
<!-- <!--   monitor = params,  --> –>
<!-- <!--   mod.name = "test-nimb") --> –> <!-- <!-- saveRDS( --> –>
<!-- <!--   results.nimb, --> –> <!-- <!--   paste0( --> –>
