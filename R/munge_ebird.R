#' @title Munge eBird Data Using Auk
#' @description Wrapper for handling eBird data using package Auk.
#' @param dir.ebd.in Directory/directories for where the __unpacked__ EDB data file(s) are stored.
